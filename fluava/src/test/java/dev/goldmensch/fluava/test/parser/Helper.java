...
public class Helper {
    ...
    public static <T> Parser<Character, T> get(String klass, String field) {
        try {
            ...
            VarHandle handle = lookup.findStaticVarHandle(recv, field, Parser.class);

            return (Parser<Character, T>) handle.get();
    ...
    public static <T> Result<Character, T> parse(String klass, String field, String content) {
        return (Result<Character, T>) get(klass, field).parseAll(content);
    }
}
